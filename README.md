...
## 一键 AI 安装（Qoder Skill）

如果你使用 [Qoder CLI](https://qoder.com)，可以使用项目内置的 `azerothcore-setup` skill 一键完成环境安装和编译：

```
/azerothcore-setup
```

Skill 会自动安装 VS2022、MySQL、CMake、OpenSSL、Boost，克隆代码，配置 CMake，编译，并提取地图数据。详见 `skills/azerothcore-setup/SKILL.md`。
